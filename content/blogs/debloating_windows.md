...
<p align= "left" style="font-size:20px; padding: 10px;">From this Menu you can Install Applications. It uses Winget to Install Applications. You can view the Logs on Other Instance of PowerShell. Then, you can shift to the tab named Tweaks.
