...
<p align= "left" style="font-size:20px; padding: 10px;">Now, Microsoft has created an Open Source Tool that is a Replacement for The Microsoft Store which is also known as Winget (Windows Package Manager), Microsoft Store has a Huge Repository of Applications and this Utility helps a lot in managing packages in Windows. Kudos to Microsoft.
Its Installation Process is really easy, and Here is a Link to its Installation Guide and its Usage Guide by Microsoft. You can also use this Website to Find Packages and their Install Commands. Here is a little GIF of the Installation Process of Discord.</p>
